...
case "DATE": return s.stage==="date"?{...s,dateConfirmed:true,stage:"dateReveal",notice:null}:s;
case "DATE_CONTINUE": return s.stage==="dateReveal"?{...s,stage:"door",notice:null}:s;
